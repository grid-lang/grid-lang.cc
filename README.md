...
├── type_processor.py  # Type definition parsing and execution
├── control_flow.py    # FOR/loop and control-flow handling
├── scope.py           # Variable scoping, inputs/outputs, constraints
